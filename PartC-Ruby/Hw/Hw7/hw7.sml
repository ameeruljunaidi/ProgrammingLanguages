...
fun intersect (v1,v2) =
    case (v1,v2) of
     ...
     |  (Point p1, Point p2) => if real_close_point p1 p2
      ...
      | (Line _, Point _) => intersect(v2,v1) (* commutative, resolved right below *)
...
(* interpreter for our language: 
   ...
   - for simplicity we have the top-level function take an environment, (which should be [] for the whole program
